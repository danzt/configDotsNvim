...
return {
  ...
  -- Copilot Chat plugin configuration
  {
    ...
    config = function(_, opts)
      ...
      -- Define custom prompts for commit messages opts.prompts.Commit =  prompt = "Write commit message for the change with commitizen convention",        selection = select.gitdiff, }
